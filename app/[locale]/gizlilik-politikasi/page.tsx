...
const content = {
  tr: {
    ...
    section2Text: "Petfendy olarak, kendi bünyemizde işlettiğimiz pet otel, pet kreş ve pet taksi hizmetleri için rezervasyon işlemlerini yönetmek amacıyla kişisel verilerinizi işlemekteyiz. Petfendy, doğrudan hizmet sağlayıcısı olarak pet sahiplerine kendi tesislerinde konaklama, gündüz bakım ve ulaşım hizmetleri sunmaktadır.",
    dataProcessingPurposes: [
      "Petfendy'nin kendi bünyesindeki pet otel, kreş ve taksi hizmetleri için rezervasyonların gerçekleştirilmesi ve yönetilmesi",
      ...
      "Sunduğumuz hizmetlerin iyileştirilmesi ve geliştirilmesi",
  ...
  en: {
    ...
    section2Text: "As Petfendy, we process your personal data to manage reservation transactions for our own pet hotel, pet daycare, and pet taxi services that we operate directly. Petfendy, as a direct service provider, offers accommodation, daycare, and transportation services to pet owners at our own facilities.",
    dataProcessingPurposes: [
      "Performing and managing reservations for Petfendy's own pet hotel, daycare, and taxi services",
      "Creating and managing user accounts",
      "Conducting communication and information activities",
      "Ensuring and increasing user satisfaction",
      "Improving and developing the services we provide",
