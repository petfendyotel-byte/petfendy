...
})(window,document,'script','dataLayer','GTM-TMX2ZJ8T');`}
        </Script>

        {/* Google Analytics (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-11166055599"
...
gtag('config', 'AW-11166055599');`}
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} font-sans antialiased`} suppressHydrationWarning>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TMX2ZJ8T"
            height="0"
            width="0"
