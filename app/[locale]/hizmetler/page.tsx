      ...
      <section className="relative py-20 px-4 bg-gradient-to-br from-orange-50 to-pink-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
            Petfendy olarak Ankara'da evcil hayvanlarınız için pet otel, pet taksi, pet kreş, 
            pet kuaför ve köpek eğitimi hizmetleri sunuyoruz. Tek çatı altında tüm pet hizmetleri.
          </p>
