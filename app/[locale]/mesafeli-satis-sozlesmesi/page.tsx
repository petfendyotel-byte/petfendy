...
export default function DistanceSellingPage() {
  ...
  const t = useTranslations('distanceSelling')
        ...
        <div className="max-w-4xl mx-auto prose prose-lg max-w-none">
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong>{t('section6.contact')}</strong>
              </p>
              <p className="text-gray-700 leading-relaxed">
                {t('section6.email')}: <a href="mailto:petfendyotel@gmail.com" className="text-orange-600 hover:underline">petfendyotel@gmail.com</a>
              </p>
            </div>
